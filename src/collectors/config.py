...
CACHE_WARMUP_SIZE = (
    50000  # Nombre de messages Kafka à lire au démarrage pour pré-remplir le cache
)

CACHE_WARMUP_HOURS = {
    "bluesky": 0.75,  # 1 heure (débit très élevé)
    "nostr": 24,  # 24 heures
